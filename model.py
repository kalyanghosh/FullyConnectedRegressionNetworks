...
from keras.layers import (Merge,merge,Reshape,Permute,UpSampling2D,Flatten)
...
def FCRN_B_base(input):
    ...
    # =========================================================================
    block3=_conv_bn_relu(128,3,3)(pool2)
    pool3=MaxPooling2D(pool_size=(1, 1))(block3)
    # =========================================================================
    block4=_conv_bn_relu(256,5,5)(pool3)
    pool4=MaxPooling2D(pool_size=(2, 2))(block4)
    # =========================================================================
    block5=_conv_bn_relu(256,3,3)(pool4)
    # =========================================================================
    up5=UpSampling2D(size=(2, 2))(block5)
    block6=_conv_bn_relu(256,5,5)(up5)
    up6=UpSampling2D(size=(4,4))(block6)
    return up6

def FCRN_B_base_v2(input):
    ...
    pool3=MaxPooling2D(pool_size=(1, 1))(block3)
    # =========================================================================
    block4=_conv_bn_relu_x2(256,5,5)(pool3)
    pool4=MaxPooling2D(pool_size=(2, 2))(block4)
    # =========================================================================
    block5=_conv_bn_relu_x2(256,3,3)(pool4)
    # =========================================================================
    up5=UpSampling2D(size=(2, 2))(block5)
    block6=_conv_bn_relu_x2(256,5,5)(up5)
    up6=UmSampling2D(size=(4,4))(block6)
    return up6
...
def buildModel_FCRN_A(input_dim):
    ...
    density_pred=Convolution2D(1, 1, 1, bias = False, activation='linear',\
                                  init='he_normal',name='pred',border_mode='same')(act_)
    # =========================================================================
...
def buildModel_FCRN_B(input_dim):
    input_=Input(shape=(input_dim))
    # =========================================================================
    act_=FCRN_B_base(input_)
    # =========================================================================
    density_pred=Convolution2D(1, 1, 1, bias = False, activation='linear',\
                                  init='he_normal',name='pred',border_mode='same')(act_)
    # =========================================================================
...
def buildModel_FCRN_B_v2(input_dim):
    input_=Input(shape=(input_dim))
    # =========================================================================
    act_=FCRN_B_base_v2(input_)
    # =========================================================================
    density_pred=Convolution2D(1, 1, 1, bias = False, activation='linear',\
                                  init='he_normal',name='pred',border_mode='same')(act_)
    # =========================================================================
